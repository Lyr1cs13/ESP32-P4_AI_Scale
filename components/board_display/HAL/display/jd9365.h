...
#define jd9365_800_1280_PANEL_30HZ_CONFIG(px_format)  \
    {                                                \
...
static const dsi_lcd_init_cmd_t inch_10_init_cmd[] =
{
    ...
    // G2.2    //G2.5
    {0x5D, (uint8_t[]){0x7F},1,0}, // 0x7F
    {0x5E, (uint8_t[]){0x6B},1,0}, // 0x69
    {0x5F, (uint8_t[]){0x5C},1,0}, // 0x59
    {0x60, (uint8_t[]){0x50},1,0}, // 0x4C
    {0x61, (uint8_t[]){0x4C},1,0}, // 0x46
    {0x62, (uint8_t[]){0x3E},1,0}, // 0x38
    {0x63, (uint8_t[]){0x41},1,0}, // 0x3A
    {0x64, (uint8_t[]){0x2B},1,0}, // 0x23
    {0x65, (uint8_t[]){0x43},1,0}, // 0x3C
    {0x66, (uint8_t[]){0x42},1,0}, // 0x3B
    {0x67, (uint8_t[]){0x43},1,0}, // 0x3B
    {0x68, (uint8_t[]){0x62},1,0}, // 0x58
    {0x69, (uint8_t[]){0x52},1,0}, // 0x46
    {0x6A, (uint8_t[]){0x5A},1,0}, // 0x4B
    {0x6B, (uint8_t[]){0x4C},1,0}, // 0x3C
    {0x6C, (uint8_t[]){0x48},1,0}, // 0x3A
    {0x6D, (uint8_t[]){0x3A},1,0}, // 0x2C
    {0x6E, (uint8_t[]){0x28},1,0}, // 0x1D
    {0x6F, (uint8_t[]){0x10},1,0}, // 0x10
    {0x70, (uint8_t[]){0x7F},1,0}, // 0x7F
    {0x71, (uint8_t[]){0x6B},1,0}, // 0x69
    {0x72, (uint8_t[]){0x5C},1,0}, // 0x59
    {0x73, (uint8_t[]){0x50},1,0}, // 0x4C
    {0x74, (uint8_t[]){0x4C},1,0}, // 0x46
    {0x75, (uint8_t[]){0x3E},1,0}, // 0x38
    {0x76, (uint8_t[]){0x41},1,0}, // 0x3A
    {0x77, (uint8_t[]){0x2B},1,0}, // 0x23
    {0x78, (uint8_t[]){0x43},1,0}, // 0x3C
    {0x79, (uint8_t[]){0x42},1,0}, // 0x3B
    {0x7A, (uint8_t[]){0x43},1,0}, // 0x3B
    {0x7B, (uint8_t[]){0x62},1,0}, // 0x58
    {0x7C, (uint8_t[]){0x52},1,0}, // 0x46
    {0x7D, (uint8_t[]){0x5A},1,0}, // 0x4B
    {0x7E, (uint8_t[]){0x4C},1,0}, // 0x3C
    {0x7F, (uint8_t[]){0x48},1,0}, // 0x3A
    {0x80, (uint8_t[]){0x3A},1,0}, // 0x2C
    {0x81, (uint8_t[]){0x28},1,0}, // 0x1D
    {0x82, (uint8_t[]){0x10},1,0}, // 0x10
    ...
    {0x37, (uint8_t[]){0x58},1,0}, // ȫ־ƽ̨add
    {0x2B, (uint8_t[]){0x0F},1,0}, // ȫ־ƽ̨add

    {0xE0, (uint8_t[]){0x05},1,0},
    {0x15, (uint8_t[]){0x1D},1,0}, // ȫ־ƽ̨add
